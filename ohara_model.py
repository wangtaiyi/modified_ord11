...
class ohara():
    ...
    def dALLdt(X, t, self):
        ...
        v, nai, nass, ki, kss, cai, cass, cansr, cajsr, m, hf, hs, j, hsp,\
            ...
            nca, ffp, fcafp, xrf, xrs, xs1, xs2, xk1, Jrelnp, Jrelp, CaMKt, a_na, a_ca, a_kr = X
        ...
        tjp = 1.46 * tj
        djp = (jss - jp) / tjp
        GNa = 75 * a_na # recalculate the conductance of INa
        ...
        zca = 2.0
        PCa = 0.0001 * a_ca # recalculate the conductance of ICa
        if celltype == 1:
            PCa = PCa * 1.2
        elif celltype == 2:
            PCa = PCa * 2.5
        ...
        GKr = 0.046 * a_kr # recalculate the conductance of IKr
        if celltype == 1:
            GKr = GKr * 1.3
        elif celltype == 2:
            GKr = GKr * 0.8
